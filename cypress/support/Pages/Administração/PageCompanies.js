...
const URL_COMPANIES = ('/empresas')
const BUTTON_NOVO = ('.btn-primary')
const BUTTON_EDIT = ('[title="F3"]')
const BUTTON_DELETE = ('.btn-danger')
const BUTTON_CORPORATE_BOARD = ('.hbox-gap > :nth-child(5)')
const BUTTON_SHARE = ('.hbox-gap > :nth-child(4)')
...
const COMBO_TAXPAYER_ISS = ('input[name="contribuinteDoIss"]')
const COMBO_TAXPAYER_ICMS = ('input[name="contribuinteDoIcms"]')
const COMBO_TAXPAYER_IPI = ('input[name="contribuinteDoIpi"]')
const COMBO_REPORT_ITEMS_OPERATIONS= ('input[name="informaItensNosDocumentos"]')
const COMBO_COUNTY = ('input[name="municipio"]')